...
class BaseRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType], ABC):
    ...
    def __init__(
        self, model: Type[ModelType], db_session: Union[Session, AsyncSession]
    ):
        self.model = model
...
class BaseRepositoryAsync(
    BaseRepository[ModelType, CreateSchemaType, UpdateSchemaType], ABC
):
    """
    ...
    def __init__(self, model: Type[ModelType], db_session: AsyncSession):
        if not hasattr(db_session, "execute"):
            raise ValueError("AsyncSession required for BaseRepositoryAsync")
