...
def main():
    ...
    if args.gui or (not any([args.cli, args.background, args.api, args.analyze, args.enhance, 
                            args.learn, args.generate, args.url])):
        # Default to GUI if no specific mode is selected
        return run_gui(args, config)
    elif args.cli or any([args.analyze, args.enhance, args.learn, args.generate, args.url]):
        ...
        logger.error("No valid launch mode specified")
        return 1
