...
pip3 install --upgrade pyinstaller pillow setuptools wheel
if [ $? -ne 0 ]; then
...
# Step 4: Build a standalone executable using PyInstaller
print_header "STEP 4: BUILDING EXECUTABLE"
